<template>
  ...
  >
    <div ref="nodes" class="sl-vue-tree-nodes-list">
      <div class="sl-vue-tree-node" v-for="(node, nodeInd) in nodes" v-bind:key="nodeInd" :class="{'sl-vue-tree-selected': node.isSelected, 'sl-vue-tree-contextmenu': node.isClickContextMenu}">
        <div
        ...
        <div
            ...
            @contextmenu.prevent="emitNodeContextmenu(node, nodeInd, $event)"
        ...
        >
          <div class="sl-vue-tree-gap" v-for="(gapInd, gapIndex) in gaps" v-bind:key="gapIndex"></div>
...
<script src="./sl-vue-tree-main.js"></script>
